...
```
> Puedes encontrar mas información en la pagina oficial [pagina oficial](https://developer.zendesk.com/api-reference/widget/answer-bot-api/) de Zendesk Answer Bot.
